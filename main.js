...
let controller = (function (budgetCtrl, UICtrl) {
    ...
    let loadData = function () {
        ...
        if (storedData) {
          ...
          storedData.allItems.inc.forEach(function (cur) {
            let newIncItem = budgetCtrl.addItem("inc", cur.description, cur.value);
            UICtrl.addListItem(newIncItem, "inc");
          });
    
          // 4. Creating  expense items
          storedData.allItems.exp.forEach(function (cur) {
            let newExpItem = budgetCtrl.addItem("exp", cur.description, cur.value);
    ...
    let updatePercentages = function () {
        ...
        // 3. Upadte the UI with the new percentages
    ...
    let ctrlDeleteItem = function (event) {
        ...
        if (itemID) {
            ...
            // 1. Delete item from the data stucture
